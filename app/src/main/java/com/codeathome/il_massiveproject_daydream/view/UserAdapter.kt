package com.codeathome.il_massiveproject_daydream.view
    ...
    inner class UserViewHolder(val v: View): RecyclerView.ViewHolder(v){
        ...
        private fun popupMenus(v: View) {
            ...
            popupMenus.setOnMenuItemClickListener {
                when(it.itemId){
                    R.id.editText->{
                        val v = LayoutInflater.from(c).inflate(R.layout.activity_tambah_obat_masuk,null)
                        val name = v.findViewById<EditText>(R.id.edtNamaObat)
                        val number = v.findViewById<EditText>(R.id.edtJumlahObat)
